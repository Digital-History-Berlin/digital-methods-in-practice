 ...
 */
public class SextoGramShinglingTrainingImpl extends AbstractSyntacticalTraining implements Training{

    @Override
    public void init() throws ConfigurationException {
        super.init();

        strHierarchy = "01-02-01-01-05";
        this.strNGramFileSuffix = "sextogram.shingle";
        intNgramSize = 6;
    ...
    protected void doPreparation() {
        ...
        setGlobalProperty("PARSER_FILTER_IMPL",
                "eu.etrap.medusa.filter.sidx.IDXRightSextoGramFilterImpl");


        this.setProperty("dblSignificanceThreshold", "0.0", "eu.etrap.medusa.filter.sidx.IDXRightSextoGramFilterImpl");
        this.setProperty("intMinimumFrequency", "0", "eu.etrap.medusa.filter.sidx.IDXRightSextoGramFilterImpl");
        this.setProperty("dblCutoffSignificanceThreshold", "0.0", "eu.etrap.medusa.filter.sidx.IDXRightSextoGramFilterImpl");
        this.setProperty("intCutoffMinimumFrequency", "0", "eu.etrap.medusa.filter.sidx.IDXRightSextoGramFilterImpl");
