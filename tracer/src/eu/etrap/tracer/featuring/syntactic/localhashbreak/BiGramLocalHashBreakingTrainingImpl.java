...
/**
 * Created on 16.03.2011 15:09:08 by mbuechler
 * @author Marco Büchler: mbuechler@etrap.eu
 */
public class BiGramLocalHashBreakingTrainingImpl extends AbstractSyntacticalTraining implements Training{
    
    @Override
    public void init() throws ConfigurationException {
        super.init();

        strHierarchy = "01-02-02-02-01";
        this.strNGramFileSuffix = "bigram.hashbreaking";
        intNgramSize=2;
    ...
    protected void doPreparation() {
        ...
        setGlobalProperty("PARSER_FILTER_IMPL",
                "eu.etrap.medusa.filter.sidx.IDXRightBiGramHashBreakingFilterImpl");


        this.setProperty("dblSignificanceThreshold", "0.0", "eu.etrap.medusa.filter.sidx.IDXRightBiGramHashBreakingFilterImpl");
        this.setProperty("intMinimumFrequency", "0", "eu.etrap.medusa.filter.sidx.IDXRightBiGramHashBreakingFilterImpl");
        this.setProperty("dblCutoffSignificanceThreshold", "0.0", "eu.etrap.medusa.filter.sidx.IDXRightBiGramHashBreakingFilterImpl");
        this.setProperty("intCutoffMinimumFrequency", "0", "eu.etrap.medusa.filter.sidx.IDXRightBiGramHashBreakingFilterImpl");
