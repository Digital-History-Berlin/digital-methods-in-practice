...
/**
 * Created on 08.12.2010 14:47:52 by mbuechler
 * @author Marco Büchler: mbuechler@etrap.eu
 */
public class GlobalContrastiveFeatureRelationSelectionImpl extends AbstractGlobalGraphSelection {

    @Override
    public void init() throws ConfigurationException {
        super.init();
        strOutFileName = FileManager.getSelectionContrastiveFeatureRelationFileName();
        this.strSortedOutFile= FileManager.getSelectionSortedContrastiveFeatureRelationFileName();
        intScaleFactor = Constants.WORD_DEPENDENCY_GRAPH_SCALEFACTOR;
        strTaxonomyCode = "01-01-01-06-03";
    }
