 ...
 */
public class GlobalEntropySelectorImpl extends AbstractGlobalSelection implements Selection {

    @Override
    public void init() throws ConfigurationException {
        super.init();
        strSortedOutFile = FileManager.getSelectionSortedEntropyFileName();
        strTaxonomyCode = "01-01-01-04-02";
    }

    @Override
    protected void doWeightFeatures() throws SelectionException {
        try {
            String strEntropyFileName = FileManager.getTrainingTrainFileName() + ".entropy";
            ...
            while (objIter.hasNext()) {
                ...
                if (intFeatID > 0) {
                    ...
                    double entropy = -1 * p * Math.log(p) / Math.log(2);
    ...
    protected void buildByteArray() throws SelectionException {
        ...
        try {
            BufferedReader objReader = new BufferedReader(new FileReader(FileManager.getSelectionSortedEntropyFileName()));
            String strLine = null;
