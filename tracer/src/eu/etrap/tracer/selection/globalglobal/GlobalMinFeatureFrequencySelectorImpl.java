 ...
 */
public class GlobalMinFeatureFrequencySelectorImpl extends AbstractFeatureFrequencySelection implements Selection {

    @Override
    public void init() throws ConfigurationException {
        super.init();
        isAscendingSortOrder = false;
        this.strSortedOutFile = FileManager.getSelectionDescSortedWordFrequencyFileName();
        strTaxonomyCode = "01-01-01-01-02";
    }
