 ...
 */
public class QuatroGramShinglingTrainingImpl extends AbstractSyntacticalTraining implements Training{

    @Override
    public void init() throws ConfigurationException {
        super.init();

        strHierarchy = "01-02-01-01-03";
        this.strNGramFileSuffix = "quadrigram.shingle";
        intNgramSize = 4;
    ...
    protected void doPreparation() {
        ...
        setGlobalProperty("PARSER_FILTER_IMPL",
                "eu.etrap.medusa.filter.sidx.IDXRightQuatroGramFilterImpl");


        this.setProperty("dblSignificanceThreshold", "0.0", "eu.etrap.medusa.filter.sidx.IDXRightQuatroGramFilterImpl");
        this.setProperty("intMinimumFrequency", "0", "eu.etrap.medusa.filter.sidx.IDXRightQuatroGramFilterImpl");
        this.setProperty("dblCutoffSignificanceThreshold", "0.0", "eu.etrap.medusa.filter.sidx.IDXRightQuatroGramFilterImpl");
        this.setProperty("intCutoffMinimumFrequency", "0", "eu.etrap.medusa.filter.sidx.IDXRightQuatroGramFilterImpl");
