 ...
 */
public class QuatroGramLocalHashBreakingTrainingImpl extends AbstractSyntacticalTraining implements Training{

    @Override
    public void init() throws ConfigurationException {
        super.init();

        strHierarchy = "01-02-02-02-03";
        this.strNGramFileSuffix = "quadrigram.hashbreaking";
        intNgramSize = 4;
    ...
    protected void doPreparation() {
        ...
        setGlobalProperty("PARSER_FILTER_IMPL",
                "eu.etrap.medusa.filter.sidx.IDXRightQuatroGramHashBreakingFilterImpl");


        this.setProperty("dblSignificanceThreshold", "0.0", "eu.etrap.medusa.filter.sidx.IDXRightQuatroGraHashBreakingmFilterImpl");
        this.setProperty("intMinimumFrequency", "0", "eu.etrap.medusa.filter.sidx.IDXRightQuatroGramHashBreakingFilterImpl");
        this.setProperty("dblCutoffSignificanceThreshold", "0.0", "eu.etrap.medusa.filter.sidx.IDXRightQuatroGramHashBreakingFilterImpl");
        this.setProperty("intCutoffMinimumFrequency", "0", "eu.etrap.medusa.filter.sidx.IDXRightQuatroGramHashBreakingFilterImpl");
