 ...
 */
public class SelectedFeatureContainmentSimilarityImpl extends AbstractAsymmetricSelectedFeatureScoring  implements Scoring{
    
    @Override
    public void init() throws ConfigurationException {
        super.init();
        strTaxonomyCode = "02-02-02-01-01-01";
    }
